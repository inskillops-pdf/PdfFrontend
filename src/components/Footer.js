    ...
    <footer className="bg-gray-800 text-white">
      <div className="container-custom py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">AI Geneuron Courses</h3>
            <p className="text-gray-300">
              Master AI, Maximize Profits. Learn the #1 AI skill used by top entrepreneurs and agencies.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/tutorials" className="text-gray-300 hover:text-white">
                  Tutorials
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
          <p>&copy; {currentYear} AI Geneuron Courses. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
