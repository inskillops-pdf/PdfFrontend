...
export default function PromptEngineeringCourse() {
  ...
  return (
    <Layout title="Advanced Prompt Engineering Course | AI Geneuron Courses">
      <div className="bg-primary-50 py-8">
        <div className="container-custom">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Advanced Prompt Engineering</h1>
              <p className="text-xl text-gray-600">
                Master the art of crafting perfect prompts for any AI model and use case
              </p>
            </div>
            <div>
              <Link href="/courses/prompt-engineering" className="btn-primary py-2 px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-md p-6 sticky top-20">
                ...
                <div className="mb-6">
                  <Link href="/courses/prompt-engineering/enroll" className="block w-full bg-primary-600 hover:bg-primary-700 text-white font-bold py-3 px-4 rounded text-center transition duration-150 ease-in-out">
                    Enroll in Course
                  </Link>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    <li>
                      <Link href="/resources/prompt-patterns" className="text-primary-600 hover:text-primary-800 flex items-center">
                    ...
                    <li>
                      <Link href="/resources/prompt-cheatsheet" className="text-primary-600 hover:text-primary-800 flex items-center">
                        <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      {activeModule === module.id && (
                        <div className="bg-white border-t border-gray-200 px-6 py-4">
                          ...
                          <div className="mt-6 flex justify-center">
                            <Link 
                              href={`/courses/prompt-engineering/module/${module.id}`}
